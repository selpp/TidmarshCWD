...
PACKET_TYPE_CONNECTION_CLOSE    = "disconnect"
...
'''
Read the given packet and returns the np array image
'''
...
class NetworkHandler:
    '''
     ...
     This class holds the callback called when receiving data from the network
    '''
